...
switch opcion
  case 1
    ...
    try
      ...
      audiowrite('Alan_octave.wav', data, recObj.SampleRate);
   ...
   case 2
     ...
     try
       disp('Reproduciendo...');
       [data, fs] = audioread('Alan_octave.wav');
       sound(data, fs);
     catch
    ...
    case 4
      ...
      try
        ...
        [audio, Fs] = audioread('Alan_octave.wav'); %lee la señal desde al archivo .wav
